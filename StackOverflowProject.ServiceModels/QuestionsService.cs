...
namespace StackOverflowProject.ServiceModels
{
    ...
    public class QuestionsService : IQuestionsService
    {
        ...
        public QuestionViewModel GetQuestionByQuestionID(int QuestionID, int UserID = 0)
        {
            ...
            if (q != null)
            {
                var config = new MapperConfiguration(cfg => { cfg.CreateMap<Question, QuestionViewModel>(); cfg.CreateMap<User, UserViewModel>();
                    cfg.CreateMap<Vote, VoteViewModel>(); cfg.CreateMap<Answer, AnswerViewModel>(); cfg.CreateMap<Category, CategoryViewModel>(); cfg.IgnoreUnmapped(); });
        ...
        public List<QuestionViewModel> GetQuestions()
        {
            ...
            var config = new MapperConfiguration(cfg => { cfg.CreateMap<User, UserViewModel>(); cfg.CreateMap<Category, CategoryViewModel>();
                cfg.CreateMap<Answer, AnswerViewModel>(); cfg.CreateMap<Question, QuestionViewModel>();
